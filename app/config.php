...
// +---------------------------------------------------------------------------+
// AgaviConfig::set('core.agavi_dir', '/home/saracen/projects/jobeet/libs/agavi');
...
AgaviConfig::set('core.upload_dir', AgaviConfig::get('core.project_dir') . '/public/upload');

// Include Zend in path
